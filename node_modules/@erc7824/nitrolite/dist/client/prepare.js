...
class NitroliteTransactionPreparer {
    ...
    async prepareCreateChannelTransaction(tokenAddress, params) {
        try {
            const { channel, initialState } = await (0, state_1._prepareAndSignInitialState)(tokenAddress, this.deps, params);
