...
import { MessageSigner, AccountID, RequestID, Timestamp, AuthRequestParams, PartialEIP712AuthMessage, EIP712AuthDomain, AuthChallengeResponse, RPCChannelStatus } from './types';
import { CloseAppSessionRequestParams, CreateAppSessionRequestParams, SubmitAppStateRequestParams, ResizeChannelRequestParams, GetLedgerTransactionsFilters, TransferRequestParams } from './types/request';
...
export declare function createGetAppSessionsMessage(signer: MessageSigner, participant: Address, status?: string, requestId?: RequestID, timestamp?: Timestamp): Promise<string>;
...
export declare function createTransferMessage(signer: MessageSigner, transferParams: TransferRequestParams, requestId?: RequestID, timestamp?: Timestamp): Promise<string>;
